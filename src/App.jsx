...
const saveCoachObjectiveFeedback = async () => {
  ...
  try {
    const { error } = await supabase
      .from("athlete_objectives")
      .update({
        coach_feedback: coachObjectiveFeedback.trim(),
      })
      .eq("athlete_id", selectedCoachAthlete.user_id);
                ...
                >
                  ...
                  (
                    ...
                    <div className="empty-state">
                      ...
                      <p>
                        Cet athlète n'a pas encore défini ses
                        objectifs dans Season.
                      </p>
                    </div>
                  ) : (
                    <div
